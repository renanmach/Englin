...
<body>
    ...
    <div class="container" align="center">
		...
		<td style="padding-right:50px;">
			<textarea placeholder=<fmt:message key="navbar.rememberit.eng_to_pt.placeholder1"/> id="text-input" name="text-input"></textarea>
		</td>
		<td><h1>></h1></td>
		<td style="padding-left:50px;">
			<textarea placeholder="<fmt:message key="navbar.rememberit.eng_to_pt.placeholder2"/>" id="text-input" name="text-input"></textarea>
		</td>
		</tr>
		</table>
		<div align="right" style="padding-top:10px">
			<input class="btn btn-sm btn-danger" type="submit" value="Next">
		</div>
		</form>
	    </div>
    </div>
